...
func NewService(repo *Repository, cache core.CacheStore, accessTokenTTL time.Duration) *Service {
	if accessTokenTTL <= 0 {
		accessTokenTTL = 15 * time.Minute
	}
	return &Service{Repo: repo, Cache: cache, AccessTokenTTL: accessTokenTTL}
}
