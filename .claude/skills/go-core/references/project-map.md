...
Public entry point for consumers. Wraps internal/coreapp with an opaque App struct.

| File | Purpose |
|------|---------|
| `app.go` | App struct, New(), RegisterRoutes(), Close() |
...
| `account_repository.go` | AdminAccount pgx/SQLC queries |
...
| `settings_repository.go` | SystemSetting pgx/SQLC queries with upsert |
...
| `repository.go` | User pgx/SQLC queries |
...
| `repository.go` | SocialAccount pgx/SQLC queries |
...
| `trusted_device_repository.go` | TrustedDevice pgx/SQLC queries |
...
| `repository.go` | WebAuthnCredential pgx/SQLC queries |
...
| `repository.go` | Role/Permission/UserRole pgx/SQLC queries |
...
| `repository.go` | Email types, templates, server configs pgx/SQLC queries |
...
| `repository.go` | ActivityLog pgx/SQLC queries |
