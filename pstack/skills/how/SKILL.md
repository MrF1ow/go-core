...
- `model`: the `how explorer` slug from `.cursor/rules/pstack-models.mdc` (then `~/.cursor/rules/pstack-models.mdc` if the project file is missing)
- `readonly`: `true`
...
- `subagent_type`: `generalPurpose`
- `model`: the `how explainer` slug from `.cursor/rules/pstack-models.mdc` (then `~/.cursor/rules/pstack-models.mdc` if the project file is missing)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in the `how critics` list from `.cursor/rules/pstack-models.mdc` (then `~/.cursor/rules/pstack-models.mdc` if the project file is missing), all in a single message.
